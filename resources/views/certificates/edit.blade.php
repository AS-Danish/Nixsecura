            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/60 overflow-hidden">
                ...
                <form action="{{ route('certificates.update', $certificate->id) }}" method="POST" enctype="multipart/form-data" class="p-8">
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <input type="text" name="title" value="{{ old('title', $certificate->title) }}"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-gray-900" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="organization" value="{{ old('organization', $certificate->organization) }}"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-gray-900" placeholder="Enter certificate organization">
                            </div>
                            ...
                            <div>
                                ...
                                <div id="uploadSection">
                                    ...
                                    <label for="certificateImage" class="flex flex-col items-center justify-center w-full px-4 py-6 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 cursor-pointer transition-all bg-gray-50 hover:bg-blue-50">
                                        <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-3">
                                            <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                            </svg>
                                        </div>
                                        <span class="text-blue-600 font-semibold text-sm mb-1">{{ $certificate->image ? 'Upload New Image' : 'Click to upload image' }}</span>
                                ...
                                <div id="imagePreview" class="hidden mt-3">
                                    <div class="relative rounded-lg overflow-hidden border border-gray-300">
                                        ...
                                        <button type="button" onclick="removeImage()" class="absolute top-2 right-2 bg-white hover:bg-red-50 text-red-600 p-2 rounded-lg shadow-md transition-all">
                        ...
                        <div class="space-y-5">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="date" value="{{ old('date', optional($certificate->date)->format('Y-m-d')) }}"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-gray-900" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                        <button type="submit" class="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300">
                        ...
                        <a href="{{ route('certificates.index') }}" class="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold py-4 px-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
                            <span class="flex items-center justify-center gap-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                                </svg>
