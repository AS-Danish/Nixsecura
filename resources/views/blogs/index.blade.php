<x-app-layout>
    <x-slot name="page-title">Blogs</x-slot>

    <!-- Blogs Section -->
    <div id="blogs" class="p-4 md:p-8 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 min-h-screen">
        ...
        <div class="relative mb-10 flex items-center justify-between flex-wrap gap-6">
            <div class="space-y-2">
                ...
                <p class="text-slate-600 text-base md:text-lg font-medium">Manage all your blog posts and articles with ease</p>
            </div>
            <button 
            ...
            >
                ...
                <span class="relative z-10 p-5">Add New Blog</span>
            </button>
        </div>
                ...
                <div class="group bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg border border-white/60 hover:shadow-2xl transition-all duration-500 overflow-hidden hover:-translate-y-2">
                    ...
                    <div class="p-6 space-y-5">
                        <div>
                            ...
                            <p class="text-slate-600 text-sm leading-relaxed line-clamp-2">{{ $blog->description }}</p>
                        </div>
                        ...
                        <div class="space-y-3 pb-5 border-b border-slate-200">
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <span class="font-bold {{ $gradient['icon'] }}">{{ $blog->date->format('M d, Y') }}</span>
                            </div>
                            ...
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <span class="font-bold text-emerald-600 text-base">{{ $blog->location }}</span>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <form action="{{ route('blogs.destroy', $blog->id) }}" method="POST" class="flex-1" onsubmit="return confirm('Are you sure you want to delete this blog? This action cannot be undone.');">
                                @csrf
                                @method('DELETE')
                                <button type="submit" 
            ...
            @empty
                <div class="flex items-center justify-center py-20">
                    <div class="text-center space-y-6">
                        <div class="space-y-2">
                            <p class="text-slate-900 text-2xl font-black">No blogs yet</p>
                            <p class="text-slate-500 text-base">Start by creating your first blog post</p>
                        </div>
                        <button 
                            onclick="openAddBlogModal()"
                        ...
                        >
                            ...
                            <span class="relative z-10">Create Your First Blog</span>
                        </button>
                    </div>
                </div>
            @endforelse
    ...
    <div id="addBlogModal" 
         ...
         onclick="if(event.target === this) closeAddBlogModal()"
    >
            ...
            <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-2xl transform transition-all modal-content" style="max-height: 90vh; height: auto;">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-5 rounded-t-xl">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div>
                                <h2 class="text-xl font-bold">Create New Blog</h2>
                                <p class="text-blue-800 text-xs">Fill in the details to add a new blog post</p>
                            </div>
                        </div>
                        <button 
                    ...
                    <form id="blogForm" onsubmit="handleSubmit(event)">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input 
                                        type="text" 
                                        name="title" 
                                        placeholder="e.g., Understanding Modern Web Development" 
                                ...
                                <div>
                                    ...
                                    <div id="uploadSection">
                                        <input type="file" name="image" id="blogImage" accept="image/jpeg,image/png,image/jpg,image/gif" class="hidden" onchange="previewImage(event)">
                                        <label 
                                            for="blogImage" 
                        ...
                        <div class="mb-6">
                            <div class="flex items-center gap-2 mb-4">
                                ...
                                <h3 class="text-base font-bold text-gray-900">Blog Details</h3>
                            </div>
                            ...
                            <div class="space-y-4">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                                            Blog Date <span class="text-red-500">*</span>
                                        </label>
                                        <input 
                                            type="date" 
                                            name="date" 
                ...
                <div class="border-t border-gray-200 bg-gray-50 px-6 py-4 flex gap-3 rounded-b-xl">
                    ...
                    <button 
                        ...
                        form="blogForm"
                        id="submitBtn"
                        class="flex-1 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-3.5 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all text-base flex items-center justify-center gap-3"
                    >
    ...
    <style>
        ...
        #addBlogModal.show .modal-backdrop {
            animation: fadeIn 0.3s ease-out forwards;
        }
        
        #addBlogModal .modal-backdrop {
            opacity: 0;
        ...
        #addBlogModal.show .modal-content {
    ...
    <script>
        function openAddBlogModal() {
            ...
            const mainContent = document.getElementById('blogs');
        ...
        document.addEventListener('keydown', function(e) {
            if (e.key === 'Escape') closeAddBlogModal();
        });
        ...
        document.getElementById('blogForm')?.addEventListener('submit', function(e) {
            ...
            .then(data => {
                if(data.success) {
                    ...
                    showError(data.message || 'Error creating blog');
