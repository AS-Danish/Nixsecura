<x-app-layout>
    ...
    <x-slot name="page-title">Edit Blog</x-slot>
    ...
    <div class="p-4 md:p-8 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 min-h-screen">
        ...
        <div class="relative mb-8">
            ...
            <div class="space-y-2">
                ...
                <p class="text-slate-600 text-base md:text-lg font-medium">Update blog details and information</p>
            </div>
        </div>
        ...
        <div class="relative max-w-4xl mx-auto">
            <div class="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/60 overflow-hidden">
                ...
                <form action="{{ route('blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data" class="p-8">
                    @csrf
                    @method('PUT')
                            ...
                            <div>
                                ...
                                @if($blog->image && file_exists(public_path($blog->image)))
                                    <div class="mb-4">
                                        ...
                                        <div class="relative inline-block">
                                            <img src="{{ asset($blog->image) }}" alt="{{ $blog->title }}" class="h-40 w-auto rounded-lg border-2 border-gray-200 shadow-md">
                                ...
                                <div id="uploadSection">
                                    ...
                                    >
                                        ...
                                        <span class="text-blue-600 font-semibold text-sm mb-1">{{ $blog->image ? 'Upload New Image' : 'Click to upload image' }}</span>
                    ...
                    <div class="mb-8">
                        <div class="flex items-center gap-2 mb-6">
                            ...
                            <h3 class="text-xl font-bold text-gray-900">Blog Details</h3>
                        </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <input 
                                        type="date" 
                                        name="date" 
                                        value="{{ old('date', $blog->date->format('Y-m-d')) }}"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-gray-900" 
                                        required
                                    >
                                </div>
