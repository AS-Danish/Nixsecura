...
<aside id="sidebar" class="fixed left-0 top-0 h-screen w-64 bg-gradient-to-br from-blue-600 to-blue-800 text-white transition-all duration-300 z-50 shadow-2xl">
    <div class="flex flex-col h-full">
        ...
        <div class="flex items-center justify-between px-6 py-6 border-b border-blue-700">
            <div class="flex items-center space-x-3">
                ...
                <span class="text-xl font-black">CyberShield</span>
            </div>
            <button id="sidebarToggle" class="lg:hidden text-white hover:bg-blue-700 p-2 rounded-lg transition">
        ...
        <nav class="flex-1 overflow-y-auto px-4 py-6 space-y-2">
            ...
            <a href="{{ route('admin.workshops.index') }}" class="sidebar-link {{ request()->routeIs('admin.workshops.*') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="px-4 py-4 border-t border-blue-700">
            <div class="flex items-center space-x-3 p-3 bg-blue-700 bg-opacity-50 rounded-xl hover:bg-opacity-70 transition cursor-pointer">
