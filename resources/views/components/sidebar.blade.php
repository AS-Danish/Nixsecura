...
<aside id="sidebar" class="fixed left-0 top-0 h-screen bg-gradient-to-br from-blue-600 to-blue-800 text-white transition-all duration-300 z-50 shadow-2xl sidebar-expanded">
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 overflow-y-auto px-4 py-6 space-y-2">
            ...
            <a href="#" class="sidebar-link" data-section="courses" title="Courses">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="#" class="sidebar-link" data-section="blogs" title="Blogs">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="#" class="sidebar-link" data-section="certificates" title="Certificates">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="#" class="sidebar-link" title="Gallery">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="#" class="sidebar-link" title="Workshops">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
