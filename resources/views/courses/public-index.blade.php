...
<head>
    ...
    <title>All Courses - Nixsecura Institute</title>
        ...
        <div id="mobile-menu" class="mobile-menu fixed top-0 right-0 h-full w-80 bg-white shadow-2xl lg:hidden z-50">
            <div class="p-6">
                ...
                <div class="space-y-4">
                    ...
                    <a href="#" class="block py-3 px-4 rounded-lg bg-blue-50 text-blue-600 font-semibold">Courses</a>
    ...
    <section class="relative pt-32 pb-16 overflow-hidden bg-gradient-to-br from-blue-50 via-blue-50 to-pink-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center">
                <span class="section-badge animate-bounce">🎓 Our Programs</span>
                <h1 class="text-5xl md:text-6xl lg:text-7xl font-black text-gray-800 mt-6 mb-6 leading-tight">
                    Explore Our
                    <span class="gradient-text block">Cyber Security Courses</span>
                </h1>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
                    Master cutting-edge skills with industry-leading training programs designed to make you job-ready in the fast-growing field of cyber security
                </p>
                
                <!-- Quick Stats -->
                <div class="flex flex-wrap justify-center gap-6 mb-8">
                    <div class="bg-white rounded-2xl px-6 py-4 shadow-lg">
                        <div class="text-3xl font-black gradient-text">50+</div>
                        <div class="text-gray-600 font-semibold">Courses</div>
                    </div>
                    <div class="bg-white rounded-2xl px-6 py-4 shadow-lg">
                        <div class="text-3xl font-black gradient-text">10K+</div>
                        <div class="text-gray-600 font-semibold">Students</div>
                    </div>
                    <div class="bg-white rounded-2xl px-6 py-4 shadow-lg">
                        <div class="text-3xl font-black gradient-text">98%</div>
                ...
                @forelse($courses as $course)
                    <div class="bg-white rounded-3xl overflow-hidden shadow-xl hover-scale border-2 border-gray-100">
                        ...
                        <div class="p-8">
                            ...
                            <h3 class="text-2xl font-black text-gray-800 mb-3 leading-tight">{{ $course->name }}</h3>
    ...
    <section class="py-20 bg-gradient-to-br from-blue-600 to-blue-800 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center text-white">
                <h2 class="text-4xl md:text-5xl font-black mb-6">Ready to Start Your Journey?</h2>
                <p class="text-xl mb-10 opacity-90 max-w-2xl mx-auto">Join thousands of students who have transformed their careers with our expert-led cyber security training</p>
