        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-10">
                    <a href="#home" class="nav-link text-gray-700 hover:text-blue-600 font-semibold">Home</a>
                    <a href="#courses" class="nav-link text-gray-700 hover:text-blue-600 font-semibold">Courses</a>
                    <a href="#certificates" class="nav-link text-gray-700 hover:text-blue-600 font-semibold">Certificates</a>
                    <a href="#blogs" class="nav-link text-gray-700 hover:text-blue-600 font-semibold">Blog</a>
                    <a href="#gallery" class="nav-link text-gray-700 hover:text-blue-600 font-semibold">Gallery</a>
